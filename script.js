...
let playerSign = "X"; // Default starting player
let runBot = true;

function clickedBox(element) {
  if (players.classList.contains("player")) {
    playerSign = "O"; // Set player sign to O if the current player is O
  ...
  if (
    ...
    setTimeout(() => {
      ...
      if (playerSign === "X") {
        ...
        document.body.classList.remove("player-win");
      } else {
    ...
    if (
      ...
      setTimeout(() => {
        ...
        document.body.classList.remove("ai-win", "player-win");
      }, 700);
